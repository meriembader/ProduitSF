...
class Categorie extends \App\Entity\Categorie implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Categorie' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Categorie' . "\0" . 'nom', '' . "\0" . 'App\\Entity\\Categorie' . "\0" . 'descrption', '' . "\0" . 'App\\Entity\\Categorie' . "\0" . 'produits'];
        }
    ...
    public function getDescrption(): ?string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDescrption', []);

        return parent::getDescrption();
    }

    /**
     * {@inheritDoc}
     */
    public function setDescrption(string $descrption): \App\Entity\Categorie
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDescrption', [$descrption]);

        return parent::setDescrption($descrption);
    }
